...
/**
 * @author alejandrorios on 9/4/20
 */
class APIAnimeAttributesMapperTest {
    @Test
    fun `when toAnime it's called then should return AnimeAttributes model`() {
        // GIVEN
        val apiAnimeAttributesSource = APIAnimeAttributes(
        ...
        // WHEN
        val result = apiAnimeAttributesSource.toAnimeAttributes()
